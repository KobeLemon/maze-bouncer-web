...
/** @type {string} */
const CACHE_VERSION = '1730020375|770562029';
/** @type {string} */
const CACHE_PREFIX = 'Maze Bouncer-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'maze-bouncer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["maze-bouncer.html","maze-bouncer.js","maze-bouncer.offline.html","maze-bouncer.icon.png","maze-bouncer.apple-touch-icon.png","maze-bouncer.worker.js","maze-bouncer.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["maze-bouncer.wasm","maze-bouncer.pck"];
